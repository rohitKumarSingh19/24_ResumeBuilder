...
import ProjectsDetailForm from "../../components/Forms/ProjectsDetailForm";
import CertificationInfoForm from "../../components/Forms/CertificationInfoForm";
...
const EditResume = () => {
      ...
      case "education-info":
        resumeData.education.forEach(
          ({degree,institution,startDate,endDate},index)=>{
            ...
            if(!startDate || !endDate)
              errors.push(
            `Start and End does not required in education ${index+1}`);
          }
        );
        break
      case "skills":
  ...
  const goToNextStep = () => {
    ...
    if(currentPage==="additoinalInfo") setOpenPreviewModal(true);
